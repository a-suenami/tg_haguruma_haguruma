...
module Api
  module ExceptionRescuable
    ...
    included do
      ...
      rescue_from ContentAuthorizationService::ContentAuthorizationError, with: :handle_content_authorization_error
    ...
    sig { params(_exception: ContentAuthorizationService::ContentAuthorizationError).void }
