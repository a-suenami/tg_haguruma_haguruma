  ...
  module Contents
    module Singleton
      class ScheduledPublicationsController < AdminArea::ApplicationController
        ...
        # POST /admin/contents/types/:content_type_id/entry/scheduled_publication
        def create
        ...
        # DELETE /admin/contents/types/:content_type_id/entry/scheduled_publication
        def destroy
        ...
        def set_content_entry
          # Singleton has only one entry per content_type
          @content_entry = T.let(
