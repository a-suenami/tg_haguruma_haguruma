...
# This is an autogenerated file for dynamic methods in `UserArea::Alpha::NewsController`.
# Please instead update this file by running `bin/tapioca dsl UserArea::Alpha::NewsController`.


class UserArea::Alpha::NewsController
