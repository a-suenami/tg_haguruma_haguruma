...
# This is an autogenerated file for dynamic methods in `UserArea::Alpha::BiographiesController`.
# Please instead update this file by running `bin/tapioca dsl UserArea::Alpha::BiographiesController`.


class UserArea::Alpha::BiographiesController
