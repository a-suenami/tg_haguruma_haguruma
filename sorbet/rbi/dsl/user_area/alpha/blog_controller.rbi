...
# This is an autogenerated file for dynamic methods in `UserArea::Alpha::BlogController`.
# Please instead update this file by running `bin/tapioca dsl UserArea::Alpha::BlogController`.


class UserArea::Alpha::BlogController
