...
# This is an autogenerated file for dynamic methods in `UserArea::Alpha::TicketsController`.
# Please instead update this file by running `bin/tapioca dsl UserArea::Alpha::TicketsController`.


class UserArea::Alpha::TicketsController
