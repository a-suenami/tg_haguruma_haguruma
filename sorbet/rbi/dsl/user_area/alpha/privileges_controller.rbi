...
# This is an autogenerated file for dynamic methods in `UserArea::Alpha::PrivilegesController`.
# Please instead update this file by running `bin/tapioca dsl UserArea::Alpha::PrivilegesController`.


class UserArea::Alpha::PrivilegesController
