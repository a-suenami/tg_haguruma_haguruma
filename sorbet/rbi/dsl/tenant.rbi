...
class Tenant
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Tenant` class because it declared `has_many :admins`.
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def saved_change_to_user_page_domain; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_user_page_domain?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { returns(T.nilable(::String)) }
    def user_page_domain; end

    sig { params(value: T.nilable(::String)).returns(T.nilable(::String)) }
    def user_page_domain=(value); end

    sig { returns(T::Boolean) }
    def user_page_domain?; end

    sig { returns(T.nilable(::String)) }
    def user_page_domain_before_last_save; end

    sig { returns(T.untyped) }
    def user_page_domain_before_type_cast; end

    sig { returns(T::Boolean) }
    def user_page_domain_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def user_page_domain_change; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def user_page_domain_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def user_page_domain_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def user_page_domain_in_database; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def user_page_domain_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def user_page_domain_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def user_page_domain_previously_was; end

    sig { returns(T.nilable(::String)) }
    def user_page_domain_was; end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_user_page_domain?(from: T.unsafe(nil), to: T.unsafe(nil)); end
  end
