...
module Flipper
  ...
  # source://flipper//lib/flipper.rb#58
...
class Flipper::Actor
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/actor.rb#17
  def ==(other); end
...
class Flipper::Adapters::Sync::FeatureSynchronizer
  ...
  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#14
  def local_actors(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#13
  def local_boolean(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#12
  def local_expression(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#15
  def local_groups(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#16
  def local_percentage_of_actors(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#18
  def local_percentage_of_time(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#23
  def remote_actors(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#22
  def remote_boolean(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#21
  def remote_expression(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#24
  def remote_groups(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#25
  def remote_percentage_of_actors(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/sync/feature_synchronizer.rb#27
...
class Flipper::DSL
  ...
  # Returns an instance of Flipper::Feature.
  #
  # source://flipper//lib/flipper/dsl.rb#248
  def [](name); end
  ...
  # source://flipper//lib/flipper/dsl.rb#13
  def export(*args, **_arg1, &block); end
...
# source://flipper//lib/flipper/export.rb#2
class Flipper::Export
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/export.rb#22
  def ==(other); end

  # source://flipper//lib/flipper/export.rb#15
  def adapter; end

  # Returns the value of attribute contents.
  #
  # source://flipper//lib/flipper/export.rb#3
  def contents; end

  # @return [Boolean]
  #
  # source://flipper//lib/flipper/export.rb#19
  def eql?(other); end

  # @raise [NotImplementedError]
  #
  # source://flipper//lib/flipper/export.rb#11
  def features; end
...
class Flipper::Expression
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/expression.rb#51
  def ==(other); end
  ...
  class << self
    ...
    # source://flipper//lib/flipper/expression.rb#30
    def new(*_arg0); end
  end
end
...
module Flipper::Expression::Builder
  ...
  # source://flipper//lib/flipper/expression/builder.rb#27
  def eq(object); end
  ...
  # source://flipper//lib/flipper/expression/builder.rb#43
  ...
  # source://flipper//lib/flipper/expression/builder.rb#37
  def gt(object); end

  # source://flipper//lib/flipper/expression/builder.rb#42
  def gte(object); end

  # source://flipper//lib/flipper/expression/builder.rb#45
  def less_than(object); end

  # source://flipper//lib/flipper/expression/builder.rb#54
  def less_than_or_equal(object); end

  # source://flipper//lib/flipper/expression/builder.rb#50
  def less_than_or_equal_to(object); end

  # source://flipper//lib/flipper/expression/builder.rb#48
  def lt(object); end

  # source://flipper//lib/flipper/expression/builder.rb#53
  def lte(object); end

  # source://flipper//lib/flipper/expression/builder.rb#32
  def neq(object); end
...
class Flipper::Expression::Constant
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/expression/constant.rb#22
  def ==(other); end
...
# source://flipper//lib/flipper/expressions/all.rb#2
module Flipper::Expressions; end

# source://flipper//lib/flipper/expressions/all.rb#3
...
class Flipper::Feature
  ...
  # Returns result of enable.
  #
  # source://flipper//lib/flipper/feature.rb#144
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/feature.rb#280
  def conditional?; end
  ...
  # Returns result of disable.
  #
  # source://flipper//lib/flipper/feature.rb#197
  ...
  # Returns result of disable.
  #
  # source://flipper//lib/flipper/feature.rb#239
  ...
  #
  # source://flipper//lib/flipper/feature.rb#376
  ...
  # Returns result of enable.
  #
  # source://flipper//lib/flipper/feature.rb#135
  ...
  #
  # source://flipper//lib/flipper/feature.rb#422
  def gate(name); end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#285
  def gate_values; end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#404
  def gates; end

  # source://flipper//lib/flipper/feature.rb#408
  def gates_hash; end
  ...
  # Returns Set of Flipper::Types::Group instances.
  #
  # source://flipper//lib/flipper/feature.rb#296
  def groups; end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#391
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/feature.rb#274
  def off?; end
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/feature.rb#269
  def on?; end
  ...
  #
  # source://flipper//lib/flipper/feature.rb#439
...
class Flipper::GateValues
  ...
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/gate_values.rb#31
  def ==(other); end
...
class Flipper::Instrumentation::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  # source://flipper//lib/flipper/instrumentation/log_subscriber.rb#70
  def logger; end

  private

  # source://flipper//lib/flipper/instrumentation/log_subscriber.rb#93
  def color_name(name); end

  class << self
    # source://flipper//lib/flipper/instrumentation/log_subscriber.rb#74
    def attach; end

    # source://flipper//lib/flipper/instrumentation/log_subscriber.rb#78
    def detach; end
  end
end
...
#
# source://flipper//lib/flipper/instrumentation/log_subscriber.rb#86
...
class Flipper::Type
  # @return [Boolean]
  #
  # source://flipper//lib/flipper/type.rb#14
  def ==(other); end
