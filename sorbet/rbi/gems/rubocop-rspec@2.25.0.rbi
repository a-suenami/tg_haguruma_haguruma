...
class RuboCop::Cop::RSpec::Rails::InferredSpecType < ::RuboCop::Cop::RSpec::Base
  ...
  # @param node [RuboCop::AST::BlockNode]
  #
  # source://rubocop-rspec//lib/rubocop/cop/rspec/rails/inferred_spec_type.rb#72
  def on_numblock(node); end
...
class RuboCop::Cop::RSpec::Rails::TravelAround < ::RuboCop::Cop::RSpec::Base
  ...
  # source://rubocop-rspec//lib/rubocop/cop/rspec/rails/travel_around.rb#66
  def on_numblock(node); end
...
class RuboCop::RSpec::Concept
  ...
  # @return [Boolean]
  #
  # source://rubocop-rspec//lib/rubocop/rspec/concept.rb#19
  def ==(other); end
