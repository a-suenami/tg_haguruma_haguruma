...
#
# source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#8
class Net::SSH::Transport::ChaCha20Poly1305Cipher
  include ::Net::SSH::Loggable

  # @return [ChaCha20Poly1305Cipher] a new instance of ChaCha20Poly1305Cipher
  #
  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#23
  def initialize(encrypt:, key:); end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#91
  def block_size; end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#103
  def implicit_mac; end

  # @return [Boolean]
  #
  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#99
  def implicit_mac?; end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#87
  def mac_length; end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#95
  def name; end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#70
  def read_and_mac(data, mac, sequence_number); end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#64
  def read_length(data, sequence_number); end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#45
  def update_cipher_mac(payload, sequence_number); end

  class << self
    # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#107
    def block_size; end

    # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#111
    def key_length; end
  end
end
...
#
# source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#12
class Net::SSH::Transport::ChaCha20Poly1305Cipher::ImplicitHMac
  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#13
  def etm; end

  # source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher.rb#18
  def key_length; end
end
...
# source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher_loader.rb#9
Net::SSH::Transport::ChaCha20Poly1305CipherLoader::ERROR = T.let(T.unsafe(nil), T.untyped)

# source://net-ssh//lib/net/ssh/transport/chacha20_poly1305_cipher_loader.rb#8
Net::SSH::Transport::ChaCha20Poly1305CipherLoader::LOADED = T.let(T.unsafe(nil), TrueClass)
