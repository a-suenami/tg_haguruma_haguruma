...
class AnnotateRb::ConfigGenerator
  class << self
    # source://annotaterb//lib/annotate_rb/config_generator.rb#25
...
class AnnotateRb::ModelAnnotator::Annotation::AnnotationBuilder
  ...
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/annotation_builder.rb#57
  def initialize(klass, options); end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/annotation_builder.rb#62
  def build; end
  ...
  # @return [Boolean]
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/annotation_builder.rb#76
...
class AnnotateRb::ModelAnnotator::Annotation::AnnotationBuilder::Annotation < ::AnnotateRb::ModelAnnotator::Components::Base
  ...
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/annotation_builder.rb#21
  def body; end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/annotation_builder.rb#34
  def build; end
  ...
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/annotation_builder.rb#50
  def columns; end
end
...
class AnnotateRb::ModelAnnotator::Annotation::SchemaHeader < ::AnnotateRb::ModelAnnotator::Components::Base
  ...
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#41
  def initialize(table_name, table_comment, database_name, options); end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#48
  def body; end
  ...
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#57
  def to_default; end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#61
  def to_markdown; end
  ...
  # @return [Boolean]
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#67
  def display_table_comments?; end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#71
  def name; end
end
...
class AnnotateRb::ModelAnnotator::Annotation::SchemaHeader::DatabaseName < ::AnnotateRb::ModelAnnotator::Components::Base
  # @return [DatabaseName] a new instance of DatabaseName
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#26
  def initialize(name); end

  # Returns the value of attribute name.
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#24
  def name; end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#30
  def to_default; end

  # source://annotaterb//lib/annotate_rb/model_annotator/annotation/schema_header.rb#34
  def to_markdown; end
end
...
class AnnotateRb::ModelAnnotator::ColumnAnnotation::ColumnComponent < ::AnnotateRb::ModelAnnotator::Components::Base
  ...
  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#78
  def to_default; end

  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#58
  def to_markdown; end

  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#35
  def to_rdoc; end

  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#43
  def to_yard; end
  ...
  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#102
  def map_col_type_to_ruby_classes(col_type); end

  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#92
  def mb_chars_ljust(string, length); end

  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_component.rb#115
...
class AnnotateRb::RouteAnnotator::BaseProcessor
  ...
  # @return [Boolean]
  #
  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#38
  ...
  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#50
  ...
  # @return [String]
  #
  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#55
  def new_text; end

  # Returns the value of attribute options.
  #
  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#44
  def options; end

  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#94
  ...
  #
  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#72
  def strip_annotations(content); end

  # source://annotaterb//lib/annotate_rb/route_annotator/base_processor.rb#61
  def write(text); end
