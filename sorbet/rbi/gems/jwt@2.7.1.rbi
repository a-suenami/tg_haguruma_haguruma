...
# source://jwt//lib/jwt/algos/hmac_rbnacl.rb#5
module JWT::Algos::HmacRbNaCl
  private

  # source://jwt//lib/jwt/algos/hmac_rbnacl.rb#35
  def key_for_rbnacl(hmac, key); end

  # source://jwt//lib/jwt/algos/hmac_rbnacl.rb#48
  def padded_empty_key(length); end

  # source://jwt//lib/jwt/algos/hmac_rbnacl.rb#44
  def resolve_algorithm(algorithm); end

  # source://jwt//lib/jwt/algos/hmac_rbnacl.rb#17
  def sign(algorithm, msg, key); end

  # source://jwt//lib/jwt/algos/hmac_rbnacl.rb#25
  def verify(algorithm, key, signing_input, signature); end
...
# source://jwt//lib/jwt/algos/hmac_rbnacl.rb#8
JWT::Algos::HmacRbNaCl::MAPPING = T.let(T.unsafe(nil), Hash)

# source://jwt//lib/jwt/algos/hmac_rbnacl.rb#15
JWT::Algos::HmacRbNaCl::SUPPORTED = T.let(T.unsafe(nil), Array)
...
# source://jwt//lib/jwt/jwk/okp_rbnacl.rb#5
class JWT::JWK::OKPRbNaCl < ::JWT::JWK::KeyBase
  # @return [OKPRbNaCl] a new instance of OKPRbNaCl
  #
  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#11
  def initialize(key, params = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#48
  def export(options = T.unsafe(nil)); end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#36
  def key_digest; end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#44
  def members; end

  # @return [Boolean]
  #
  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#40
  def private?; end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#30
  def signing_key; end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#24
  def verify_key; end
  ...
  # @raise [JWT::JWKError]
  #
  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#75
  def check_jwk_params!(key_params, _given_params); end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#56
  def extract_key_params(key); end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#79
  def parse_okp_key_params(verify_key, signing_key = T.unsafe(nil)); end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#97
  def signing_key_from_parameters; end

  # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#93
  def verify_key_from_parameters; end

  class << self
    # source://jwt//lib/jwt/jwk/okp_rbnacl.rb#104
    def import(jwk_data); end
  end
end

# source://jwt//lib/jwt/jwk/okp_rbnacl.rb#6
JWT::JWK::OKPRbNaCl::KTY = T.let(T.unsafe(nil), String)

# source://jwt//lib/jwt/jwk/okp_rbnacl.rb#7
JWT::JWK::OKPRbNaCl::KTYS = T.let(T.unsafe(nil), Array)

# source://jwt//lib/jwt/jwk/okp_rbnacl.rb#9
JWT::JWK::OKPRbNaCl::OKP_PRIVATE_KEY_ELEMENTS = T.let(T.unsafe(nil), Array)

# source://jwt//lib/jwt/jwk/okp_rbnacl.rb#8
JWT::JWK::OKPRbNaCl::OKP_PUBLIC_KEY_ELEMENTS = T.let(T.unsafe(nil), Array)
