...
module OAuth2
  ...
  #
  # source://oauth2//lib/oauth2.rb#72
  def configure; end
  ...
  class << self
    ...
    #
    # source://oauth2//lib/oauth2.rb#63
    def config; end
    ...
    # @yieldparam config [SnakyHash::SymbolKeyed] the configuration object
    #
    # source://oauth2//lib/oauth2.rb#75
    def configure; end
  end
end
...
class OAuth2::AccessToken
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#186
  def [](key); end
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#368
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#200
  def expired?; end
  ...
  # @return [Boolean]
  #
  # source://oauth2//lib/oauth2/access_token.rb#193
  def expires?; end
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#340
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#361
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#347
  ...
  # @see AccessToken#request
  #
  # source://oauth2//lib/oauth2/access_token.rb#354
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#215
  ...
  # @yieldparam opts [Hash] The options hash that can be modified
  #
  # source://oauth2//lib/oauth2/access_token.rb#231
  def refresh!(params = T.unsafe(nil), access_token_opts = T.unsafe(nil), &block); end
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#332
  ...
  # @yieldparam req [Faraday::Request] The request object that can be modified
  #
  # source://oauth2//lib/oauth2/access_token.rb#264
  ...
  # @yieldparam req [Faraday::Request] The request object that can be modified
  #
  # source://oauth2//lib/oauth2/access_token.rb#291
  def revoke!(params = T.unsafe(nil), &block); end
  ...
  #
  # source://oauth2//lib/oauth2/access_token.rb#298
  def to_hash; end
  ...
  # source://oauth2//lib/oauth2/access_token.rb#379
  def configure_authentication!(opts, verb); end

  # source://oauth2//lib/oauth2/access_token.rb#414
...
#
# source://oauth2//lib/oauth2/authenticator.rb#10
class OAuth2::Authenticator
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#16
  def id; end
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#93
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#82
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#70
  ...
  #
  # source://oauth2//lib/oauth2/authenticator.rb#103
...
class OAuth2::Client
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#339
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#471
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#537
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#556
  ...
  # @yieldparam req [Faraday::Request] the request object that can be modified
  #
  # source://oauth2//lib/oauth2/client.rb#444
  def execute_request(verb, url, opts = T.unsafe(nil)); end

  # source://oauth2//lib/oauth2/client.rb#565
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#361
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#512
  ...
  #
  # source://oauth2//lib/oauth2/client.rb#489
  ...
  #   - HTTP headers (Hash)
  #
  # source://oauth2//lib/oauth2/client.rb#406
...
#
# source://oauth2//lib/oauth2.rb#47
...
#
# source://oauth2//lib/oauth2/error.rb#8
class OAuth2::Error < ::StandardError
  ...
  #
  # source://oauth2//lib/oauth2/error.rb#18
  ...
  #
  # source://oauth2//lib/oauth2/error.rb#13
  def body; end
  ...
  #
  # source://oauth2//lib/oauth2/error.rb#45
  ...
  #
  # source://oauth2//lib/oauth2/error.rb#67
...
module OAuth2::FilteredAttributes
  ...
  # @return [String]
  #
  # source://oauth2//lib/oauth2/filtered_attributes.rb#38
  def inspect; end
  ...
  class << self
    ...
    # @return [void]
    #
    # source://oauth2//lib/oauth2/filtered_attributes.rb#13
...
#
# source://oauth2//lib/oauth2/filtered_attributes.rb#18
module OAuth2::FilteredAttributes::ClassMethods
  # The configured attribute names to filter.
  #
  # @return [Array<Symbol>]
  #
  # source://oauth2//lib/oauth2/filtered_attributes.rb#30
  ...
  # @return [void]
  #
  # source://oauth2//lib/oauth2/filtered_attributes.rb#23
...
# @return [Boolean]
#
# source://oauth2//lib/oauth2.rb#36
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-15#section-4.1
#
# source://oauth2//lib/oauth2/strategy/auth_code.rb#18
class OAuth2::Strategy::AuthCode < ::OAuth2::Strategy::Base
  # The required query parameters for the authorize URL
  #
  # @param params [Hash] additional query parameters
  #
  # source://oauth2//lib/oauth2/strategy/auth_code.rb#22
  ...
  #
  # source://oauth2//lib/oauth2/strategy/auth_code.rb#40
  ...
  # @raise [ArgumentError]
  #
  # source://oauth2//lib/oauth2/strategy/auth_code.rb#52
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-26#section-4.2
#
# source://oauth2//lib/oauth2/strategy/implicit.rb#16
class OAuth2::Strategy::Implicit < ::OAuth2::Strategy::Base
  # The required query parameters for the authorize URL
  #
  # @param params [Hash] additional query parameters
  #
  # source://oauth2//lib/oauth2/strategy/implicit.rb#20
  def authorize_params(params = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://oauth2//lib/oauth2/strategy/implicit.rb#35
  ...
  # @raise [ArgumentError]
  #
  # source://oauth2//lib/oauth2/strategy/implicit.rb#41
  def assert_valid_params(params); end
end
...
# @see http://datatracker.ietf.org/doc/html/draft-ietf-oauth-v2-15#section-4.3
#
# source://oauth2//lib/oauth2/strategy/password.rb#16
class OAuth2::Strategy::Password < ::OAuth2::Strategy::Base
  # Not used for this strategy
  #
  # @raise [NotImplementedError]
  #
  # source://oauth2//lib/oauth2/strategy/password.rb#20
  def authorize_url; end
  ...
  # @param params [Hash] additional params
  #
  # source://oauth2//lib/oauth2/strategy/password.rb#29
