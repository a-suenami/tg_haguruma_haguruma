...
module Pagy::UrlHelpers
  ...
  # Overridable by the jsonapi extra
  #
  # source://pagy//lib/pagy/url_helpers.rb#23
  ...
  def pagy_url_for(pagy, page, absolute: T.unsafe(nil), html_escaped: T.unsafe(nil), **_); end
end
