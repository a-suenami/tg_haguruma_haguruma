...
class Liquid::BlockBody
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/block_body.rb#175
  def blank?; end
  ...
  #
  # source://liquid//lib/liquid/block_body.rb#194
  def remove_blank_strings; end

  # source://liquid//lib/liquid/block_body.rb#199
  def render(context); end

  # source://liquid//lib/liquid/block_body.rb#203
  def render_to_output_buffer(context, output); end

  # source://liquid//lib/liquid/block_body.rb#161
  def whitespace_handler(token, parse_context); end

  private

  # source://liquid//lib/liquid/block_body.rb#233
  def create_variable(token, parse_context); end

  # @yield [nil, nil]
  #
  # source://liquid//lib/liquid/block_body.rb#112
...
# source://liquid//lib/liquid/condition.rb#159
class Liquid::Condition::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/condition.rb#160
  def children; end
end
...
class Liquid::Context
  ...
  #
  # source://liquid//lib/liquid/context.rb#164
  def []=(key, value); end
  ...
  # for that
  #
  # source://liquid//lib/liquid/context.rb#70
  def add_filters(filters); end

  # source://liquid//lib/liquid/context.rb#76
  def apply_global_filter(obj); end

  # source://liquid//lib/liquid/context.rb#159
  ...
  # source://liquid//lib/liquid/context.rb#184
  ...
  #
  # source://liquid//lib/liquid/context.rb#189
  ...
  # source://liquid//lib/liquid/context.rb#95
  ...
  # source://liquid//lib/liquid/context.rb#103
  ...
  #   context['var']  #=> nil
  #
  # source://liquid//lib/liquid/context.rb#132
  ...
  # source://liquid//lib/liquid/context.rb#62
  def strainer; end
  ...
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/context.rb#231
  ...
  # source://liquid//lib/liquid/context.rb#220
  ...
  # source://liquid//lib/liquid/context.rb#267
  ...
  # source://liquid//lib/liquid/context.rb#274
  def squash_instance_assigns_with_environments; end

  # source://liquid//lib/liquid/context.rb#243
...
class Liquid::Cycle < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/tags/cycle.rb#37
  def render_to_output_buffer(context, output); end
  ...
  # source://liquid//lib/liquid/tags/cycle.rb#62
...
class Liquid::Cycle::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/cycle.rb#70
  def children; end
end
...
class Liquid::Decrement < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/tags/decrement.rb#27
  def render_to_output_buffer(context, output); end
end
...
# source://liquid//lib/liquid/condition.rb#169
class Liquid::ElseCondition < ::Liquid::Condition
  # @return [Boolean]
  #
  # source://liquid//lib/liquid/condition.rb#170
  def else?; end
...
#
# source://liquid//lib/liquid/expression.rb#18
...
class Liquid::ForloopDrop < ::Liquid::Drop
  ...
  # source://liquid//lib/liquid/forloop_drop.rb#74
  def first; end

  # source://liquid//lib/liquid/forloop_drop.rb#42
  def index; end

  # source://liquid//lib/liquid/forloop_drop.rb#50
  def index0; end

  # source://liquid//lib/liquid/forloop_drop.rb#82
  def last; end
  ...
  # source://liquid//lib/liquid/forloop_drop.rb#58
  def rindex; end

  # source://liquid//lib/liquid/forloop_drop.rb#66
  def rindex0; end

  protected

  # source://liquid//lib/liquid/forloop_drop.rb#88
  def increment!; end
end
...
class Liquid::I18n
  ...
  # source://liquid//lib/liquid/i18n.rb#20
...
class Liquid::Include < ::Liquid::Tag
  ...
  # @raise [ArgumentError]
  #
  # source://liquid//lib/liquid/tags/include.rb#53
  def render_to_output_buffer(context, output); end
  ...
  # source://liquid//lib/liquid/tags/include.rb#99
  def parse_context; end
end

# source://liquid//lib/liquid/tags/include.rb#102
class Liquid::Include::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/include.rb#103
  def children; end
end
...
class Liquid::Increment < ::Liquid::Tag
  ...
  # source://liquid//lib/liquid/tags/increment.rb#27
  def render_to_output_buffer(context, output); end
end

# source://liquid//lib/liquid/tags/inline_comment.rb#17
class Liquid::InlineComment < ::Liquid::Tag
  # @return [InlineComment] a new instance of InlineComment
  #
  # source://liquid//lib/liquid/tags/inline_comment.rb#18
  def initialize(tag_name, markup, options); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/tags/inline_comment.rb#37
  def blank?; end

  # source://liquid//lib/liquid/tags/inline_comment.rb#33
  def render_to_output_buffer(_context, output); end
end
...
class Liquid::ParseContext
  ...
  # source://liquid//lib/liquid/parse_context.rb#34
  def partial=(value); end

  # source://liquid//lib/liquid/parse_context.rb#41
...
class Liquid::RangeLookup
  ...
  #
  # source://liquid//lib/liquid/range_lookup.rb#17
  ...
  # source://liquid//lib/liquid/range_lookup.rb#22
  ...
  # source://liquid//lib/liquid/range_lookup.rb#30
...
# source://liquid//lib/liquid/range_lookup.rb#41
class Liquid::RangeLookup::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/range_lookup.rb#42
  def children; end
end
...
class Liquid::Raw < ::Liquid::Block
  ...
  #
  # source://liquid//lib/liquid/tags/raw.rb#19
  def initialize(tag_name, markup, parse_context); end
  ...
  # source://liquid//lib/liquid/tags/raw.rb#25
  def parse(tokens); end
...
# source://liquid//lib/liquid/tags/raw.rb#17
...
class Liquid::Render < ::Liquid::Tag
  ...
  # @raise [::ArgumentError]
  #
  # source://liquid//lib/liquid/tags/render.rb#60
...
# source://liquid//lib/liquid/tags/render.rb#98
class Liquid::Render::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/render.rb#99
  def children; end
end
...
module Liquid::StandardFilters
  # source://liquid//lib/liquid/standardfilters.rb#702
  def abs(input); end

  # source://liquid//lib/liquid/standardfilters.rb#590
  def append(input, string); end

  # source://liquid//lib/liquid/standardfilters.rb#815
  def at_least(input, n); end

  # source://liquid//lib/liquid/standardfilters.rb#830
  def at_most(input, n); end

  # source://liquid//lib/liquid/standardfilters.rb#145
  def base64_decode(input); end

  # source://liquid//lib/liquid/standardfilters.rb#134
  def base64_encode(input); end

  # source://liquid//lib/liquid/standardfilters.rb#169
  def base64_url_safe_decode(input); end

  # source://liquid//lib/liquid/standardfilters.rb#158
  def base64_url_safe_encode(input); end

  # source://liquid//lib/liquid/standardfilters.rb#68
  def capitalize(input); end

  # source://liquid//lib/liquid/standardfilters.rb#789
  def ceil(input); end

  # source://liquid//lib/liquid/standardfilters.rb#488
  def compact(input, property = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#605
  ...
  # source://liquid//lib/liquid/standardfilters.rb#747
  def divided_by(input, operand); end

  # source://liquid//lib/liquid/standardfilters.rb#46
  def downcase(input); end

  # source://liquid//lib/liquid/standardfilters.rb#79
  def escape(input); end

  # source://liquid//lib/liquid/standardfilters.rb#91
  def escape_once(input); end

  # source://liquid//lib/liquid/standardfilters.rb#680
  def first(array); end

  # source://liquid//lib/liquid/standardfilters.rb#802
  def floor(input); end

  # source://liquid//lib/liquid/standardfilters.rb#82
  def h(input); end

  # source://liquid//lib/liquid/standardfilters.rb#328
  def join(input, glue = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#691
  def last(array); end

  # source://liquid//lib/liquid/standardfilters.rb#281
  def lstrip(input); end

  # source://liquid//lib/liquid/standardfilters.rb#466
  def map(input, property); end

  # source://liquid//lib/liquid/standardfilters.rb#725
  def minus(input, operand); end

  # source://liquid//lib/liquid/standardfilters.rb#760
  def modulo(input, operand); end

  # source://liquid//lib/liquid/standardfilters.rb#630
  def newline_to_br(input); end

  # source://liquid//lib/liquid/standardfilters.rb#714
  def plus(input, operand); end

  # source://liquid//lib/liquid/standardfilters.rb#619
  def prepend(input, string); end

  # source://liquid//lib/liquid/standardfilters.rb#557
  def remove(input, string); end

  # source://liquid//lib/liquid/standardfilters.rb#568
  def remove_first(input, string); end

  # source://liquid//lib/liquid/standardfilters.rb#579
  def remove_last(input, string); end

  # source://liquid//lib/liquid/standardfilters.rb#514
  def replace(input, string, replacement = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#525
  def replace_first(input, string, replacement = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#536
  def replace_last(input, string, replacement); end

  # source://liquid//lib/liquid/standardfilters.rb#454
  def reverse(input); end

  # source://liquid//lib/liquid/standardfilters.rb#773
  def round(input, n = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#292
  def rstrip(input); end

  # source://liquid//lib/liquid/standardfilters.rb#35
  def size(input); end

  # source://liquid//lib/liquid/standardfilters.rb#185
  ...
  # source://liquid//lib/liquid/standardfilters.rb#368
  def sort_natural(input, property = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#259
  ...
  # source://liquid//lib/liquid/standardfilters.rb#317
  def strip_newlines(input); end

  # source://liquid//lib/liquid/standardfilters.rb#736
  ...
  # source://liquid//lib/liquid/standardfilters.rb#233
  def truncatewords(input, words = T.unsafe(nil), truncate_string = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#428
  def uniq(input, property = T.unsafe(nil)); end

  # source://liquid//lib/liquid/standardfilters.rb#57
  ...
  # source://liquid//lib/liquid/standardfilters.rb#395
  def where(input, property, target_value = T.unsafe(nil)); end

  private

  # source://liquid//lib/liquid/standardfilters.rb#864
  def apply_operation(input, operand, operation); end

  # Returns the value of attribute context.
  #
  # source://liquid//lib/liquid/standardfilters.rb#858
  def context; end

  # source://liquid//lib/liquid/standardfilters.rb#883
  def nil_safe_casecmp(a, b); end

  # source://liquid//lib/liquid/standardfilters.rb#869
  def nil_safe_compare(a, b); end

  # @raise [Liquid::ArgumentError]
  #
  # source://liquid//lib/liquid/standardfilters.rb#860
  def raise_property_error(property); end
end

# source://liquid//lib/liquid/standardfilters.rb#10
Liquid::StandardFilters::HTML_ESCAPE = T.let(T.unsafe(nil), Hash)

# source://liquid//lib/liquid/standardfilters.rb#17
Liquid::StandardFilters::HTML_ESCAPE_ONCE_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://liquid//lib/liquid/standardfilters.rb#891
class Liquid::StandardFilters::InputIterator
  include ::Enumerable

  # @return [InputIterator] a new instance of InputIterator
  #
  # source://liquid//lib/liquid/standardfilters.rb#894
  def initialize(input, context); end

  # source://liquid//lib/liquid/standardfilters.rb#923
  def compact; end

  # source://liquid//lib/liquid/standardfilters.rb#911
  def concat(args); end

  # source://liquid//lib/liquid/standardfilters.rb#932
  def each; end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/standardfilters.rb#927
  def empty?; end

  # source://liquid//lib/liquid/standardfilters.rb#907
  def join(glue); end

  # source://liquid//lib/liquid/standardfilters.rb#915
  def reverse; end

  # source://liquid//lib/liquid/standardfilters.rb#919
  def uniq(&block); end
end

# source://liquid//lib/liquid/standardfilters.rb#9
Liquid::StandardFilters::MAX_INT = T.let(T.unsafe(nil), Integer)

# source://liquid//lib/liquid/standardfilters.rb#18
...
module Liquid::StrainerFactory
  ...
  # source://liquid//lib/liquid/strainer_factory.rb#17
  def global_filter_names; end

  private

  # source://liquid//lib/liquid/strainer_factory.rb#37
  def strainer_class_cache; end

  # source://liquid//lib/liquid/strainer_factory.rb#25
  def strainer_from_cache(filters); end
end

# source://liquid//lib/liquid/strainer_factory.rb#21
...
# source://liquid//lib/liquid/tags/table_row.rb#80
class Liquid::TableRow::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/tags/table_row.rb#81
  def children; end
end
...
class Liquid::Tag
  ...
  # Returns the value of attribute parse_context.
  #
  # source://liquid//lib/liquid/tag.rb#6
  def options; end
  ...
  class << self
    ...
    # source://liquid//lib/liquid/tag.rb#22
    def new(*_arg0); end
  end
end
...
class Liquid::Template
  ...
  # source://liquid//lib/liquid/template.rb#119
  def assigns; end

  # source://liquid//lib/liquid/template.rb#127
  def errors; end

  # source://liquid//lib/liquid/template.rb#123
  ...
  # source://liquid//lib/liquid/template.rb#115
  def registers; end
  ...
  #
  # source://liquid//lib/liquid/template.rb#145
  def render(*args); end
...
class Liquid::Variable
  ...
  # Returns the value of attribute parse_context.
  #
  # source://liquid//lib/liquid/variable.rb#23
  def options; end
...
class Liquid::VariableLookup
  ...
  # source://liquid//lib/liquid/variable_lookup.rb#39
  def evaluate(context); end

  # @return [Boolean]
  #
  # source://liquid//lib/liquid/variable_lookup.rb#35
  ...
  # source://liquid//lib/liquid/variable_lookup.rb#86
  def state; end
...
# source://liquid//lib/liquid/variable_lookup.rb#90
class Liquid::VariableLookup::ParseTreeVisitor < ::Liquid::ParseTreeVisitor
  # source://liquid//lib/liquid/variable_lookup.rb#91
  def children; end
end
