...
class Sidekiq::JobRetry
  ...
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#70
  ...
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#79
  ...
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#112
  def local(jobinst, jobstr, queue); end

  private

  # source://sidekiq//lib/sidekiq/job_retry.rb#294
  def compress_backtrace(backtrace); end

  # returns (strategy, seconds)
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#196
  def delay_for(jobinst, count, exception, msg); end

  # @return [Boolean]
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#273
  def exception_caused_by_shutdown?(e, checked_causes = T.unsafe(nil)); end

  # Extract message from exception.
  # Set a default if the message raises an error
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#286
  ...
  # best effort.
  #
  # source://sidekiq//lib/sidekiq/job_retry.rb#140
  def process_retry(jobinst, msg, queue, exception); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#227
  def retries_exhausted(jobinst, msg, exception); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#265
  def retry_attempts_from(msg_retry, default); end

  # source://sidekiq//lib/sidekiq/job_retry.rb#251
  def send_to_morgue(msg); end
end

# source://sidekiq//lib/sidekiq/job_retry.rb#68
Sidekiq::JobRetry::DEFAULT_MAX_RETRY_ATTEMPTS = T.let(T.unsafe(nil), Integer)

# source://sidekiq//lib/sidekiq/job_retry.rb#62
class Sidekiq::JobRetry::Handled < ::RuntimeError; end

# source://sidekiq//lib/sidekiq/job_retry.rb#64
...
class Sidekiq::JobSet < ::Sidekiq::SortedSet
  # @api private
  #
  # source://sidekiq//lib/sidekiq/api.rb#763
...
class Sidekiq::ProcessSet
  ...
  #
  # source://sidekiq//lib/sidekiq/api.rb#955
  def total_rss; end
...
class Sidekiq::SortedSet
  ...
  # @return [Boolean] always true
  #
  # source://sidekiq//lib/sidekiq/api.rb#649
  def 💣; end
end
