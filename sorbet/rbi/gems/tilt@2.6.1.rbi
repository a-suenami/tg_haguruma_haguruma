...
#
# source://tilt//lib/tilt/liquid.rb#16
class Tilt::LiquidTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/liquid.rb#33
  def allows_script?; end

  # source://tilt//lib/tilt/liquid.rb#22
  def evaluate(scope, locs); end

  # source://tilt//lib/tilt/liquid.rb#17
  def prepare; end
end
