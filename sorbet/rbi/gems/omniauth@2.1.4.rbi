...
module OmniAuth
  class << self
    # source://omniauth//lib/omniauth.rb#143
    def config; end

    # @yield [config]
    #
    # source://omniauth//lib/omniauth.rb#147
    def configure; end

    # source://omniauth//lib/omniauth.rb#151
    def logger; end

    # source://omniauth//lib/omniauth.rb#155
...
class OmniAuth::Builder < ::Rack::Builder
  ...
  # source://omniauth//lib/omniauth/builder.rb#47
  def call(env); end
  ...
  # source://omniauth//lib/omniauth/builder.rb#27
  def options(options = T.unsafe(nil)); end

  # source://omniauth//lib/omniauth/builder.rb#33
...
class OmniAuth::Configuration
  ...
  #
  # source://omniauth//lib/omniauth.rb#57
  def initialize; end
  ...
  # source://omniauth//lib/omniauth.rb#109
  def add_mock(provider, original = T.unsafe(nil)); end

  # source://omniauth//lib/omniauth.rb#101
  def after_request_phase(&block); end

  # Sets the attribute after_request_phase
  #
  # @param value the value to set the attribute after_request_phase to.
  #
  ...
  #
  # source://omniauth//lib/omniauth.rb#139
  ...
  # source://omniauth//lib/omniauth.rb#93
  def before_request_phase(&block); end
  ...
  class << self
    ...
    # source://omniauth//lib/omniauth.rb#29
    def allocate; end
...
module OmniAuth::Strategy
  ...
  # source://omniauth//lib/omniauth/strategy.rb#398
  def auth_hash; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#477
  def call_app!(env = T.unsafe(nil)); end

  # Performs the steps necessary to run the callback phase of a strategy.
  #
  # source://omniauth//lib/omniauth/strategy.rb#268
  def callback_call; end

  # source://omniauth//lib/omniauth/strategy.rb#453
  def callback_path; end

  # source://omniauth//lib/omniauth/strategy.rb#424
  ...
  # source://omniauth//lib/omniauth/strategy.rb#433
  ...
  # source://omniauth//lib/omniauth/strategy.rb#394
  def extra; end

  # source://omniauth//lib/omniauth/strategy.rb#542
  def fail!(message_key, exception = T.unsafe(nil)); end

  # source://omniauth//lib/omniauth/strategy.rb#484
  def full_host; end
  ...
  # in test mode.
  #
  # source://omniauth//lib/omniauth/strategy.rb#307
  def mock_call!(*_arg0); end

  # source://omniauth//lib/omniauth/strategy.rb#342
  def mock_callback_call; end

  # source://omniauth//lib/omniauth/strategy.rb#320
  def mock_request_call; end

  # source://omniauth//lib/omniauth/strategy.rb#521
  def name; end
  ...
  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#280
  def on_auth_path?; end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#292
  def on_callback_path?; end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#296
  def on_path?(path); end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#284
  ...
  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#300
  def options_request?; end

  # source://omniauth//lib/omniauth/strategy.rb#429
  def path_prefix; end

  # source://omniauth//lib/omniauth/strategy.rb#473
  def query_string; end

  # source://omniauth//lib/omniauth/strategy.rb#525
  ...
  # source://omniauth//lib/omniauth/strategy.rb#444
  ...
  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#417
  def skip_info?; end

  # source://omniauth//lib/omniauth/strategy.rb#382
  def uid; end

  # source://omniauth//lib/omniauth/strategy.rb#538
  def user_info; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#565
  def merge_stack(stack); end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#572
  def ssl?; end

  private

  # source://omniauth//lib/omniauth/strategy.rb#560
...
# source://omniauth//lib/omniauth/strategy.rb#468
...
# source://omniauth//lib/omniauth.rb#159
module OmniAuth::Utils
  private

  # source://omniauth//lib/omniauth.rb#181
  def camelize(word, first_letter_in_uppercase = T.unsafe(nil)); end

  # source://omniauth//lib/omniauth.rb#166
  def deep_merge(hash, other_hash); end

  # source://omniauth//lib/omniauth.rb#162
  def form_css; end
