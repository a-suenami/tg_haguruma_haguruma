...
module FFaker::AddressIN
  ...
  # source://ffaker//lib/ffaker/address_in.rb#14
  def pincode; end
...
module FFaker::AddressPL
  ...
  # source://ffaker//lib/ffaker/address_pl.rb#73
  def postal_code; end

  # A voivodeship is an administrative area in Poland - a Polish equivalent of state.
  #
  # source://ffaker//lib/ffaker/address_pl.rb#44
  def province; end
  ...
  # A voivodeship is an administrative area in Poland - a Polish equivalent of state.
  #
  # source://ffaker//lib/ffaker/address_pl.rb#43
  def state; end
...
module FFaker::Boolean
  ...
  # source://ffaker//lib/ffaker/boolean.rb#15
  def random; end

  # source://ffaker//lib/ffaker/boolean.rb#16
  def sample; end
end
...
module FFaker::Gender
  ...
  # source://ffaker//lib/ffaker/gender.rb#19
  def maybe; end

  # source://ffaker//lib/ffaker/gender.rb#11
  def random; end

  # source://ffaker//lib/ffaker/gender.rb#20
  def sample; end
end
...
module FFaker::GenderBR
  ...
  # source://ffaker//lib/ffaker/gender_br.rb#14
  def maybe; end

  # source://ffaker//lib/ffaker/gender_br.rb#10
  def random; end

  # source://ffaker//lib/ffaker/gender_br.rb#15
  def sample; end
end
...
module FFaker::GenderCN
  ...
  # source://ffaker//lib/ffaker/gender_cn.rb#14
  def maybe; end

  # source://ffaker//lib/ffaker/gender_cn.rb#10
  def random; end

  # source://ffaker//lib/ffaker/gender_cn.rb#15
  def sample; end
end
...
module FFaker::GenderID
  ...
  # source://ffaker//lib/ffaker/gender_id.rb#14
  def maybe; end

  # source://ffaker//lib/ffaker/gender_id.rb#10
  def random; end

  # source://ffaker//lib/ffaker/gender_id.rb#15
  def sample; end
end
...
module FFaker::GenderIT
  ...
  # source://ffaker//lib/ffaker/gender_it.rb#14
  def maybe; end

  # source://ffaker//lib/ffaker/gender_it.rb#10
  def random; end

  # source://ffaker//lib/ffaker/gender_it.rb#15
  def sample; end
end
...
module FFaker::GenderJA
  ...
  # source://ffaker//lib/ffaker/gender_ja.rb#15
  def maybe; end

  # source://ffaker//lib/ffaker/gender_ja.rb#11
  def random; end

  # source://ffaker//lib/ffaker/gender_ja.rb#16
  def sample; end
end
...
module FFaker::GenderKR
  ...
  # source://ffaker//lib/ffaker/gender_kr.rb#14
  def maybe; end

  # source://ffaker//lib/ffaker/gender_kr.rb#10
  def random; end

  # source://ffaker//lib/ffaker/gender_kr.rb#15
  def sample; end
end
...
module FFaker::GenderPL
  ...
  # source://ffaker//lib/ffaker/gender_pl.rb#16
  def maybe; end

  # source://ffaker//lib/ffaker/gender_pl.rb#12
  def random; end

  # source://ffaker//lib/ffaker/gender_pl.rb#17
  def sample; end
end
...
module FFaker::GenderRU
  ...
  # source://ffaker//lib/ffaker/gender_ru.rb#19
  def maybe; end

  # source://ffaker//lib/ffaker/gender_ru.rb#11
  def random; end

  # source://ffaker//lib/ffaker/gender_ru.rb#20
  def sample; end
end
...
module FFaker::IdentificationESCO
  ...
  # source://ffaker//lib/ffaker/identification_es_co.rb#20
  def id; end
end
...
module FFaker::IdentificationPL
  ...
  #
  # source://ffaker//lib/ffaker/identification_pl.rb#29
  def id; end
...
module FFaker::Lorem
  ...
  # source://ffaker//lib/ffaker/lorem.rb#29
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem.rb#35
...
module FFaker::LoremAR
  ...
  # source://ffaker//lib/ffaker/lorem_ar.rb#24
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_ar.rb#30
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremBR
  ...
  # source://ffaker//lib/ffaker/lorem_br.rb#29
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_br.rb#35
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremFR
  ...
  # source://ffaker//lib/ffaker/lorem_fr.rb#23
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_fr.rb#29
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremIE
  ...
  # source://ffaker//lib/ffaker/lorem_ie.rb#20
  def phrase; end

  # source://ffaker//lib/ffaker/lorem_ie.rb#26
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremIT
  ...
  # source://ffaker//lib/ffaker/lorem_it.rb#23
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_it.rb#29
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremKR
  ...
  # source://ffaker//lib/ffaker/lorem_kr.rb#20
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_kr.rb#26
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremPL
  ...
  # source://ffaker//lib/ffaker/lorem_pl.rb#34
  def phrase(count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_pl.rb#40
...
module FFaker::LoremRU
  ...
  # source://ffaker//lib/ffaker/lorem_ru.rb#23
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_ru.rb#29
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::LoremUA
  ...
  # source://ffaker//lib/ffaker/lorem_ua.rb#23
  def phrase(word_count = T.unsafe(nil)); end

  # source://ffaker//lib/ffaker/lorem_ua.rb#29
  def phrases(sentence_count = T.unsafe(nil)); end
...
module FFaker::NameGR
  ...
  # Random full name (male or female). Arguments :male, :female, :any
  #
  # source://ffaker//lib/ffaker/name_gr.rb#17
  def name(gender = T.unsafe(nil)); end
end
...
module FFaker::NameJA
  ...
  # source://ffaker//lib/ffaker/name_ja.rb#20
  def name; end
end
...
module FFaker::NameKR
  ...
  # source://ffaker//lib/ffaker/name_kr.rb#24
  def last_first; end
...
module FFaker::NameMX
  ...
  #
  # source://ffaker//lib/ffaker/name_mx.rb#78
  def first_name(gender = T.unsafe(nil)); end
  ...
  # A single name according to gender parameter
  #
  # source://ffaker//lib/ffaker/name_mx.rb#77
...
module FFaker::NamePL
  ...
  # Acceptable gender values: :random, :female, :male
  #
  # source://ffaker//lib/ffaker/name_pl.rb#23
  def full_name(gender = T.unsafe(nil)); end
...
module FFaker::Vehicle
  ...
  # source://ffaker//lib/ffaker/vehicle.rb#91
