...
class JSON::Util::UUID < ::Struct
  ...
  #
  # source://json-schema//lib/json-schema/util/uuid.rb#235
  def guid; end
  ...
  #
  # source://json-schema//lib/json-schema/util/uuid.rb#250
  def to_i; end
  ...
  class << self
    ...
    # rewrite it with c :)
    #
    # source://json-schema//lib/json-schema/util/uuid.rb#199
    def create_v1(clock = T.unsafe(nil), time = T.unsafe(nil), mac_addr = T.unsafe(nil)); end

    # UUID generation using MD5 (for backward compat.)
    #
    # source://json-schema//lib/json-schema/util/uuid.rb#100
    ...
    # unique.
    #
    # source://json-schema//lib/json-schema/util/uuid.rb#117
    def create_v4; end

    # UUID generation using SHA1. Recommended over create_md5.
    # Namespace object is another UUID, some of them are pre-defined below.
    #
    # source://json-schema//lib/json-schema/util/uuid.rb#87
...
class JSON::Validator
  ...
  # source://json-schema//lib/json-schema/validator.rb#598
  def custom_open(uri); end

  # source://json-schema//lib/json-schema/validator.rb#522
  def fake_uuid(schema); end

  # source://json-schema//lib/json-schema/validator.rb#573
  def initialize_data(data); end

  # source://json-schema//lib/json-schema/validator.rb#526
  ...
  class << self
    # source://json-schema//lib/json-schema/validator.rb#310
    def add_schema(schema); end

    # source://json-schema//lib/json-schema/validator.rb#329
    def cache_schemas=(val); end

    # source://json-schema//lib/json-schema/validator.rb#301
    def clear_cache; end

    # source://json-schema//lib/json-schema/validator.rb#338
    def default_validator; end

    # source://json-schema//lib/json-schema/validator.rb#389
    ...
    # source://json-schema//lib/json-schema/validator.rb#403
    def json_backend; end

    # source://json-schema//lib/json-schema/validator.rb#411
    def json_backend=(backend); end

    # source://json-schema//lib/json-schema/validator.rb#454
    def merge_missing_values(source, destination); end

    # source://json-schema//lib/json-schema/validator.rb#425
    def parse(s); end

    # source://json-schema//lib/json-schema/validator.rb#377
    ...
    # source://json-schema//lib/json-schema/validator.rb#373
    def register_validator(v); end

    # source://json-schema//lib/json-schema/validator.rb#396
    def restore_default_formats(versions = T.unsafe(nil)); end

    # source://json-schema//lib/json-schema/validator.rb#314
    def schema_for_uri(uri); end

    # source://json-schema//lib/json-schema/validator.rb#324
    def schema_key_for(uri); end

    # @return [Boolean]
    #
    # source://json-schema//lib/json-schema/validator.rb#320
    ...
    # source://json-schema//lib/json-schema/validator.rb#306
    def schemas; end
    ...
    # source://json-schema//lib/json-schema/validator.rb#354
    ...
    # source://json-schema//lib/json-schema/validator.rb#334
    def validators; end
  end
end
